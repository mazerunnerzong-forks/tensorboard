...
class TestableComponent {
  ...
  triggerViewBoxChange(viewBox: Extent) {
    this.chart.onViewBoxChanged(viewBox);
  }
}
...
describe('line_chart_v2/line_chart test', () => {
  ...
  beforeEach(async () => {
    ...
    resizeSpy = spyOn(Chart.prototype, 'resize');
    disposeSpy = spyOn(Chart.prototype, 'dispose');
    setXScaleTypeSpy = spyOn(Chart.prototype, 'setXScaleType');
    setYScaleTypeSpy = spyOn(Chart.prototype, 'setYScaleType');
    updateMetadataSpy = spyOn(Chart.prototype, 'updateMetadata');
    updateDataSpy = spyOn(Chart.prototype, 'updateData');
    updateViewBoxSpy = spyOn(Chart.prototype, 'updateViewBox');
  });
  ...
  function createComponent(input: {
    ...
    if (input.defaultViewBox) {
      fixture.componentInstance.defaultViewBox = input.defaultViewBox;
    }
  ...
  it('uses the defaultViewBox when configured', () => {
    const fixture = createComponent({
      seriesData: [
        buildSeries({
          id: 'foo',
